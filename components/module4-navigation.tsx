...
export function Module4Navigation() {
  return (
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            ...
            <div className="text-left">
              ...
              <p className="text-white font-medium">Módulo 3: Análisis Institucional</p>
            </div>
          </a>
          ...
          {/* Módulo Siguiente */}
          <a
            href="/recursos/gpt-forex-pro-avanzado/modulo-5"
            className="flex items-center gap-4 p-4 bg-[#1a1a1a] border border-[#333] rounded-lg hover:border-[#8b3bc0] transition-colors group w-full md:w-auto"
          >
            <div className="text-right">
              <p className="text-[#b1a2d6] text-sm">Siguiente</p>
              <p className="text-white font-medium">Módulo 5: Proyecto Final</p>
            </div>
